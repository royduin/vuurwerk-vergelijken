...
*/
$config['tables']['users']           = 'gebruikers';
$config['tables']['groups']          = 'gebruikers_groepen';
$config['tables']['users_groups']    = 'gebruikers_groepen_fk';
$config['tables']['login_attempts']  = 'gebruikers_login';
 ...
 */
$config['site_title']                 = "Vuurwerk-vergelijken.nl";       // Site Title, example.com
$config['admin_email']                = "info@vuurwerk-vergelijken.nl"; // Admin Email, admin@example.com
$config['default_group']              = 'gebruiker';           // Default group, use name
...
$config['user_expire']                = 1209600;               // How long to remember the user (seconds). Set to zero for no expiration
